...
MoneyLooterTitleFS:SetFont(ML_STRINGS.FONT, 17, "")
...
MoneyLooterTimeLabelFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterTimeFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterRawGoldLabelFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterRawGoldFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterItemsGoldLabelFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterItemsGoldFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterGPHLabelFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterGPHFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterPriciestLabelFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterPriciestFS:SetFont(ML_STRINGS.FONT, 12, "")
...
MoneyLooterScrollLootFrame:SetFont(ML_STRINGS.FONT, 12, "")
