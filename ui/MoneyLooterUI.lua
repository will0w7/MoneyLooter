...
MoneyLooterTitleFS:SetFont(ML_STRINGS.FONT_OLD, 17, "")
MoneyLooterTitleFS:SetText(ML_STRINGS.TITLE_OLD)
...
MoneyLooterTimeLabelFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterTimeFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterRawGoldLabelFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterRawGoldFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterItemsGoldLabelFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterItemsGoldFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterGPHLabelFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterGPHFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterPriciestLabelFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterPriciestFS:SetFont(ML_STRINGS.FONT_OLD, 12, "")
...
MoneyLooterScrollLootFrame:SetFont(ML_STRINGS.FONT_OLD, 12, "")
